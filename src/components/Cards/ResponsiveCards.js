...
const features = [
  {
    title: "هرجا هستی خیالت راحته با شبینجا",
    description:
      "رزرو اقامتگاه امن و راحت با بیمه مسافرتی و پشتیبانی ۲۴ ساعته در شبینجا. با استفاده از خدمات شبینجا، می‌توانید با خیال راحت به سفر بروید. ما برای تمام سفرهای شما بیمه مسافرتی کامل و پشتیبانی ۲۴ ساعته ارائه می‌دهیم تا تجربه‌ای بی‌نظیر و بدون نگرانی داشته باشید. با شبینجا، سفرتان همیشه در آرامش است.",
    icon: <ThumbUpAltIcon fontSize="large" />,
  },
  {
    title: "دنیایی از انتخاب در شبینجا - هر زمان و هر مکان",
    description:
      "شبینجا، بهترین پلتفرم برای رزرو اقامتگاه در ایران و جهان. در هر کجای دنیا که هستید، با شبینجا می‌توانید بهترین اقامتگاه‌ها را پیدا و رزرو کنید. از ویلاهای لوکس تا بوم‌گردی‌های خاص، گزینه‌های متنوع برای هر سلیقه‌ای در دسترس شماست. سریع، آسان و مطمئن، هر زمانی که بخواهید با شبینجا سفر خود را برنامه‌ریزی کنید.",
    icon: <PublicIcon fontSize="large" />,
  },
  {
    title: "همراه همیشگی در سفر - هیچ وقت تنها نمی‌مانی",
    description:
      "با شبینجا، رزرو اقامتگاه، بلیط هواپیما و تور مسافرتی بدون دردسر. ما در شبینجا همراه شما در تمامی مراحل سفر هستیم. از رزرو اقامتگاه تا خرید بلیط هواپیما و تور، همیشه در کنار شما خواهیم بود تا تجربه‌ای راحت و بدون استرس داشته باشید. شبینجا همراه مطمئن شما در هر قدم از سفر.",
      ...
      <Grid container spacing={4} justifyContent="center">
        {features.map((feature, index) => (
          <Grid
            ...
            sx={{
              position: "relative",
              // top: index === 1 ? { md: 32 } : 0, // Lower the center card on desktop
            }}
          >
